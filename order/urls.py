...
urlpatterns = [
    ...
    url(r'^product-sizes/', views.ProductSizeList.as_view(), name='product_sizes'),
    url(r'^product-sizes-mobile/', views.MobileProductSizeList.as_view(), name='mobile_product_sizes'),
